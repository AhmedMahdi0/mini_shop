...
{{--    <form action="{{url('inventory/add/vendor/'.$inventoryId)}}" method="get" id="filter">--}}
{{--        <div class="row">--}}
...
{{--    </form>--}}
    <form action="{{url('inventory/add/vendor/'.$inventoryId)}}" method="post">
        @csrf
    <table class="table table-striped table-light">
        ...
        @foreach ($vendors as $vendor)
            <tr>
                <td><input class="form-check-input mt-0 border-primary" type="checkbox" value="{{$vendor->id}}" aria-label="Checkbox for following text input"name="vendors[]"></td>
