                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('password.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="email" class="form-control" type="email" name="email" required autofocus value="{{old('email', $request->email)}}">
                                ...
                                <div class="flex items-center justify-end mt-4">
                                    <input type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" value="{{ __('Reset Password') }}">
                                </div>
                            </form>
                        </div>
                    </div>
